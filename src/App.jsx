  ...
  return (
    <div className=" h-screen w-full">
      ...
      <div className=" h-full w-full absolute pointer-events-none top-0 left-0 p-10">
        ...
        <div ref={colplate} className="absolute opacity-0 sm:h-fit sm:w-[17vw] w-[50%] h-[20vh] left-1/2 -translate-x-1/2 sm:left-[10%] top-[20%] rounded-lg flex flex-col items-center justify-start sm:justify-between bg-zinc-100 sm:top-1/2 -translate-y-1/2 p-5">
